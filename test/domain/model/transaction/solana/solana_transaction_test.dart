...
import 'package:solana_wallet/domain/model/transaction/solana/transfer/sol_transfer_transaction.dart';
import 'package:test/test.dart';

void main() {
  group('SolanaTransactionTest', () {
    test('createSolTokenTransferTransaction', () {
      ...
      var unsigned = SOLTransferTransaction(
          fromAddress,
          toAddress,
          blockhash,
          lamports
    ...
    test('signSolTokenTransferTransaction', () async {
      ...
      var transaction = SOLTransferTransaction(
          fromAddress,
          toAddress,
          blockhash,
          lamports
      ...
      Transaction signedTransaction = await transaction.signTransaction([
